        ...
        {!loading && !error && (<div className='grid lg:grid-cols-3 gap-[30px] lg:gap-[50px]'>
          ...
          <div className="lg:col-span-2">
            ...
            <div className='mt-8'>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-[6px]">
                      <span className='flex items-center gap-[6px] text-headingColor text-[14px]
                        leadibg-5 lg:text-[16px] lg:leading-6 font-semibold'><img src={starIcon} alt="" />
                        {data.averageRating?.toFixed(2)}
                      </span>
                      <span className='text-textColor text-[14px]leadibg-5 lg:text-[16px] lg:leading-6 font-semibold'>
                        ({data.totalRating})
                      </span>
                    </div>
              ...
              {tab=='appointments' && <Appointments appointment={data.appointment}/>}
              {tab=='settings' && <Profile doctorData={data}/>}
              {tab=='timeSlot' && <TimeSlot doctorData={data}/>}
