...
const socialLinks = [
  {
    ...
    icon: <AiFillYoutube className='groupe-hover:text-white w-4 h-5' />,
  },
  {
    path: "https://www.github.com",
    icon: <AiFillGithub className='groupe-hover:text-white w-4 h-5' />,
  },
  {
    path: "https://www.instagram.com",
    icon: <AiOutlineInstagram className='groupe-hover:text-white w-4 h-5' />,
  }
];
        ...
        <div className="flex justify-between flex-col md:flex-row flex-wrap gap-[30px]">
          <div>
            ...
            <p className="text-[16px] leading-7 font-[400] text-textColor mt-4">
              Copyright © {year} developed by Amine all right reserved.
            </p>
